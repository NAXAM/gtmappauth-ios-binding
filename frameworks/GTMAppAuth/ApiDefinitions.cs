...
namespace GTMAppAuth
{
	...
	partial interface Constants
	{
		...
		[Field ("GTMAppAuthFetcherAuthorizationErrorDomain")]
		unsafe int* GTMAppAuthFetcherAuthorizationErrorDomain { get; }
	}

	// typedef void (^GTMAppAuthFetcherAuthorizationCompletion)(int * _Nullable);
	unsafe delegate void GTMAppAuthFetcherAuthorizationCompletion ([NullAllowed] int* arg0);
	...
	interface GTMAppAuthFetcherAuthorization
	{
		...
		unsafe int* ServiceProvider { get; }
		...
		unsafe int* UserEmailIsVerified { get; }
	...
	partial interface Constants
	{
		...
		[Field ("GTMTVDeviceTokenGrantType")]
		NSString GTMTVDeviceTokenGrantType { get; }
	}
